...
const TestimonialsSection = () => {
  return (
   <section className='py-16 px-4 m:px-6 lg:px-8 bg-background'>
    <div className='max-w-7xl mx-auto'>
      ...
      {/* Testimonila grid */}
      <div className='grid grid-cols-1 mid:grid-cols-2 lg:grid-cols-4 gap-6'>
      ...
      <div className='text-center mt-8'>
        <button className='text-chart-2 hover:text-char-2/80 font-medium transition-colors duration-200'>
        Read More
        </button>
